...
content preservation: **67%** (chrome-excluded; 181 non-blank content cells)

## Before (color-stripped)

```
╭────────────────────────────────────╮╭──────────────────────────────╮
│ SERVICE        STATE      REGION   ││ name:    billing             │
│ api-gateway    running    eu-1     ││ state:   degraded            │
│ auth-service   running    eu-1     ││ region:  us-1                │
...
application @0,0,78,10
  table @0,0,38,8
    ...
    row @1,6,36,1
      ...
      cell @28,6,6,1 eu-1
  list @38,0,32,6
    property "name" @39,1,30,1 billing
    property "state" @39,2,30,1 degraded
    property "region" @39,3,30,1 us-1
